	...
	<div class="wrapper">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar" style="height: auto;">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="/OrderingSystem-0.0.1-SNAPSHOT/reservation">
		...
		<div class="content-wrapper" style="min-height: 916px;">
			...
			<section class="content">
				<div class="row">
				<form:form role ="form" method="POST" action="/OrderingSystem-0.0.1-SNAPSHOT/reservation" modelAttribute="reservation">
					<div class="col-md-12">
