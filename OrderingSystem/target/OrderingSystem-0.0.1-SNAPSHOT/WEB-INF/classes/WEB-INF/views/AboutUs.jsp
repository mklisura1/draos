...
<!--[if lt IE 9]>
	...
	<script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=true&key=AIzaSyAcwM2tz_LrVb6p1-6EuDr3RZzBLWZSchE&libraries=places&language=en-US"></script>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar" style="height: auto;">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="/OrderingSystem-0.0.1-SNAPSHOT/aboutus"> <i
					...
					<li><a href="/OrderingSystem-0.0.1-SNAPSHOT/gallery"> <i class="fa fa-tv"></i>
							<span>Gallery</span>
					</a></li>
