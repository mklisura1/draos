...
<!-- Bootstrap 3.3.5 -->
<link rel="stylesheet"
	href="/OrderingSystem-0.0.1-SNAPSHOT/resources/bootstrap/css/bootstrap.min.css">
<!-- Font Awesome -->
<link rel="stylesheet"
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar" style="height: auto;">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="#"> <i class="fa fa-circle-o"></i> <span>General
								information</span>
					</a></li>
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="/OrderingSystem-0.0.1-SNAPSHOT/admin/user/add"><i
									class="fa fa-user-plus"></i>Add new user</a></li>
							<li><a href="/OrderingSystem-0.0.1-SNAPSHOT/admin/user/list"><i
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Information edit</li>
				</ol>
			</section>
			...
			<section class="content">
				<!-- Info boxes -->
				<div class="row">
					<!-- red za general details -->
					<form:form method="POST"
						action="/OrderingSystem-0.0.1-SNAPSHOT/admin/information/edit/${infromation_id}"
